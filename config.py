...
Từ điều này, Bạn hãy cố gắng trích xuất được 2 thông tin của user : họ tên, số tài khoản ngân hàng (viết tắt stk) nhưng phải khéo léo, ít hỏi lại, thể hiện sự tin tưởng, sau 3,4 tin nhắn mới hỏi về thông tin
